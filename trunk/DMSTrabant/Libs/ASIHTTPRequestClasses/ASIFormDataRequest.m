...
@property (retain) NSMutableArray *headerMultyPartData;
...
-(void)addHeaderMultyPartData:(NSDictionary *)values
{
    if (![self headerMultyPartData]) {
		[self setHeaderMultyPartData:[NSMutableArray array]];
	}
    [[self headerMultyPartData ] addObject:values];
}
...
- (id)copyWithZone:(NSZone *)zone
{
    ...
    [newRequest setHeaderMultyPartData:[[[self headerMultyPartData] mutableCopyWithZone:zone] autorelease]];
...
@synthesize headerMultyPartData;
@synthesize postData;
@synthesize fileData;
