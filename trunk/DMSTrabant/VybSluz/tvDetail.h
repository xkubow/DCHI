...
typedef enum {eVYBAVATEXT=1, eCELKYODLOZBTN, eCELKYSLUZBABTN, eCELKYPOZAD, eCELKYPC, eSLUZBAPC, eBTNCLEARROW, eOKBTN, eDETAILTEXT, eDETAIL, eTITLETEXT} cellContentType;
